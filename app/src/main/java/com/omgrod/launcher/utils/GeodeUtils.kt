...
import com.omgrod.launcher.activityresult.GeodeOpenFileActivityResult
import com.omgrod.launcher.activityresult.GeodeOpenFilesActivityResult
import com.omgrod.launcher.activityresult.GeodeSaveFileActivityResult
import java.io.File
...
object GeodeUtils {
    ...
    fun isGeodeUri(uri: Uri): Boolean {
        return "com.omgrod.launcher.user" == uri.authority
    }
